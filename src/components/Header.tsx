export default function Header() {
  return (
    ...
    <header className="top-0 z-10 flex h-12 animate-fade flex-row items-center justify-between border-indigo-700 bg-indigo-950 px-4 text-white transition-all duration-700 animate-ease-in-out sm:left-0 sm:h-full sm:min-h-screen sm:w-24 sm:flex-col sm:justify-center sm:border-r-2 sm:px-0 sm:py-6">
      {/* Icon */}
