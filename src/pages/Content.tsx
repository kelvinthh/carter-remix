export default function Content() {
  return (
    <div className="flex h-screen w-full animate-fade flex-col items-center overflow-auto bg-black pb-16 text-white animate-delay-500">
      {/* Earn $1000 Text */}
      ...
      <div className="flex w-full flex-col items-center justify-center space-y-2 py-16 text-center font-light sm:space-y-4">
        <h1 className="animate-fade-down text-4xl font-bold animate-delay-[500ms] animate-ease-in-out sm:text-6xl">
          Chat With{" "}
